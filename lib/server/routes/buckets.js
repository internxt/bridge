    ...
    async.eachLimit(
      ...
      (shard, cb) => {
        ...
        Upload.findOne({
          ...
          if (!uuid) {
            return cb(new errors.BadRequestError('Shard without UUID'));
          }

          const contractsObject = contracts.reduce((object, contract) => {
            object[contract.nodeID]= { ...contract.contract, data_hash: hash };
    ...
    async.mapLimit(
      ...
      (shardId, nextShardId) => {
        ...
        Shard.findOne({
          ...
          if (!shard) {
            return nextShardId(new errors.NotFoundError('Shard not found'));
          }
          ...
          Mirror.findOne({
            ...
            Contact.findOne({
              ...
              if (!contact) {
                return nextShardId(new errors.NotFoundError('Contact not found'));
              }
